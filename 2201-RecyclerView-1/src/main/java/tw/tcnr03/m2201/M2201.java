...
public class M2201 extends AppCompatActivity {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()){
                    case R.id.action_search:
                        Toast.makeText(M2201.this, getString(R.string.action_search), Toast.LENGTH_LONG).show();
                        break;
                    case R.id.action_notifications:
                        Toast.makeText(M2201.this, getString(R.string.action_notifications), Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.action_settings:
                        Toast.makeText(M2201.this, getString(R.string.action_settings), Toast.LENGTH_SHORT).show();
                        finish();
                        break;
                }
                return true;
    ...
    private void initRecyclerView() {
        //1 實例化RecyclerView
        r001 = (RecyclerView) findViewById(R.id.m2201_r001);
